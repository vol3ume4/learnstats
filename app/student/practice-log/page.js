        ...
        <div className="container">
            ...
            <div className="card">
                ...
                <button
                    ...
                    disabled={loading || !selectedTopic || !selectedPattern}
                    style={{ width: '100%' }}
                >
            ...
            {!selectedTopic || !selectedPattern ? (
                <div className="card" style={{ textAlign: 'center', padding: '3rem', color: 'var(--text-secondary)' }}>
                    Please select a Topic and Pattern to view your practice history
                </div>
            ) : null}
            ...
            {history.length === 0 && !loading && selectedTopic && selectedPattern && (
                <div className="card" style={{ textAlign: 'center', padding: '3rem', color: 'var(--text-secondary)' }}>
                    No practice history found for the selected filters
                </div>
            )}
        </div>
    );
