      ...
      {!topicId ? (
        ...
        <div>
          ...
          <div className="card" style={{ background: 'var(--primary)', color: 'white', marginBottom: '1.5rem' }}>
            ...
            >
              <option value="view_patterns">📂 View & Manage Patterns</option>
              <option value="generate_patterns">🤖 Generate New Patterns with AI</option>
              <option value="add_pattern_manual">✍️ Add a Pattern Manually</option>
              <option value="generate_questions">⚡ Generate Questions with AI</option>
              <option value="add_question_manual">📝 Add a Question Manually</option>
            </select>
          </div>
          ...
          {activeTab === 'generate_patterns' && (
            <div className="card">
              <h3 className="section-title">Generate Patterns with AI</h3>
              ...
              {generatedPatterns.length > 0 && (
                <div style={{ marginTop: '2rem', borderTop: '1px solid var(--border)', paddingTop: '1.5rem' }}>
                  <h4 style={{ marginBottom: '1rem' }}>Select Patterns to Keep</h4>
          ...
          {activeTab === 'add_pattern_manual' && (
            <div className="card">
              <h3 className="section-title">Add Pattern Manually</h3>
          ...
          {activeTab === 'generate_questions' && (
            <div className="card">
              ...
              <div className="form-group">
                <label className="label">1. Select Pattern Context</label>
                <select
                  className="select"
                  onChange={(e) => {
