...
async function setAdmin() {
    try {
        ...
        const usersQuery = 'SELECT user_id, email, is_admin FROM profiles ORDER BY created_at DESC LIMIT 10';
        ...
        console.log('UPDATE profiles SET is_admin = TRUE WHERE user_id = \'paste-user-id-here\';');
        ...
        // await client.query('UPDATE profiles SET is_admin = TRUE WHERE user_id = $1', [YOUR_USER_ID]);
